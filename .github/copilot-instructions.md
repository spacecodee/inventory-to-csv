...
- **Styling**: The project uses **TailwindCSS v4**. All styling must be done through Tailwind classes. Do not write custom, non-Tailwind CSS properties directly if not neccesary.
