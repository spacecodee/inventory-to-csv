  ...
  private getBarcodePrintStyles(): string {
    return `
      <style>
        ...
        .label { width: 80mm; height: 70mm; page-break-after: always; display:flex; flex-direction:column; align-items:flex-start; justify-content:flex-start; padding-top: 15mm; padding-left: 15mm; gap: 1mm; box-sizing: border-box; }
        img.bar { width: 38mm; height: 10mm; display:block; }
        .code-text { font-size: 10px; font-family: monospace; text-align: center; word-break: break-all; width: 38mm; }
      </style>
      <style media="print">
        @page { margin: 0; }
  ...
  private getSingleBarcodePrintStyles(): string {
    return `
      <style>
        @page { size: 80mm 70mm; margin: 0; }
        html, body { margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; }
        .label { width: 80mm; height: 70mm; display:flex; flex-direction:column; align-items:flex-start; justify-content:flex-start; padding-top: 15mm; padding-left: 15mm; gap: 1mm; box-sizing: border-box; }
